...
class DoctoresM extends ConexionBD {
    ...
    static public function CrearDoctorM($tablaBD, $datosC) {
        ...
        $pdo = null;
    } // 👈 ESTA LLAVE FALTABA EN TU ARCHIVO ORIGINAL


    // Verificar si el usuario ya existe
    static public function VerDoctorUsuarioM($tablaBD, $usuario) {
        ...
        return $resultado; // Devuelve los datos si existe, o false si no
    }
