...
<!-- Site wrapper -->
  ...
  if(isset($_SESSION["Ingresar"]) && $_SESSION["Ingresar"] == true){
    ...
    if(isset($_GET["url"])){
      ...
      // Aquí verificamos si la URL es "documentosP" y si tiene un ID de usuario
      if($url[0] == "documentosP" && isset($url[1])){ 
        // Cargamos el módulo "documentosP.php"
        include "modulos/documentosP.php";
      }
      else if($url[0] == "inicio" || $url[0] == "salir" || $url[0] == "perfil-Secretaria" || $url[0] == "perfil-S" || $url[0] == "consultorios" || $url[0] == "E-C" || $url[0] == "doctores" || $url[0] == "pacientes" || $url[0] == "perfil-Paciente" || $url[0] == "perfil-P" || $url[0] == "Ver-consultorios" || $url[0] == "Doctor" || $url[0] == "historial" || $url[0] == "perfil-Doctor" || $url[0] == "perfil-D" || $url[0] == "Citas" || $url[0] == "perfil-Administrador" || $url[0] == "perfil-A" || $url[0] == "secretarias" || $url[0] == "inicio-editar"){
